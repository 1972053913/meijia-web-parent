<template>
        <el-container style="height: 630px">
            <el-aside width="300px">
                <el-tree :data="productTypes" :props="defaultProps" @node-contextmenu="handleNodeClick"></el-tree>
            </el-aside>
            <el-main>
                <!--新增界面-->
                <el-dialog title="新增/编辑" :visible.sync="addFormVisible" width="30%">
                    <el-form :model="productType" label-width="80px" row-style="height:10px">
                        ...
                        <el-form-item label="创建时间">
                            <el-input v-model="productType.createTime" :disabled="true"></el-input>
                        </el-form-item>
                        <el-form-item label="修改时间">
                            <el-input v-model="productType.updateTime" :disabled="true"></el-input>
                        </el-form-item>
                    </el-form>
            ...
            <div v-show="menuVisible">
                <ul id="menu" class="menu">
                    ...
                    <li class="menu__item" @click="editCard">编辑</li>
